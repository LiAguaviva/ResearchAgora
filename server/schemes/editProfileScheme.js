...
export const editProfileScheme = z.object({
  ...
  user_lastname: z.string().min(1, '* B Please enter your lastname').nullable()
  .refine((val) => val !== null, { message: '* B Please enter your lastname' }),
  ...
  user_description: z.string().max(250, '* B Description cannot exceed 250 characters').nullable()
  // .refine((val) => val !== null, { message: '* Description cannot be null' })
  .optional(),

  user_proficiency: z.string().max(50, '* B Profiency cannot exceed 50 characters').nullable(),
  ...
  user_current_boss: z.string().max(100, '* B Curent head cannot exceed 100 characters').nullable(),
