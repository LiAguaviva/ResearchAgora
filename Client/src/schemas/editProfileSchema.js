...
export const editProfileSchema = z.object({
  ...
  user_proficiency: z.string().max(250, '* Description cannot exceed 250 characters').optional(),
  user_current_lab: z.string().max(250, '* Description cannot exceed 250 characters').optional(),
  user_current_boss: z.string().max(250, '* Description cannot exceed 250 characters').optional(),
});